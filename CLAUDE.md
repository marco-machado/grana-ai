...
- TypeScript 5.8+ (Node 22 Alpine) + Next.js 15 (App Router), Prisma 6, `@anthropic-ai/sdk`, `zod`, `unpdf` (003-statement-processing)
- PostgreSQL 17 (Docker), accessed via Prisma. New models: Transaction, StagingTransaction, ProcessedStatement. (003-statement-processing)
...
## Recent Changes
- 003-statement-processing: Added TypeScript 5.8+ (Node 22 Alpine) + Next.js 15 (App Router), Prisma 6, `@anthropic-ai/sdk`, `zod`, `unpdf`
